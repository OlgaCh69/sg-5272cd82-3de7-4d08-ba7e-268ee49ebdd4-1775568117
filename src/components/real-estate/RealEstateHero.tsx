    ...
    <section className="relative min-h-screen flex items-center overflow-hidden bg-[#0a0a0a]">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          {/* Right side - Revenue Increase Image */}
          <div className="relative hidden lg:block">
            <div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-2xl">
              <Image 
                src="/real-estate-ai-assistant-revenue-increase.webp"
                alt="AI Real Estate Revenue Increase Dashboard"
                width={800}
                height={600}
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-[#0a0a0a]/40 to-transparent pointer-events-none"></div>
            </div>
          </div>
        </div>
      </div>
