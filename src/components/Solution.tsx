...
export function Solution() {
  ...
  const messages = [
    { platform: "WhatsApp", color: "bg-[#25D366]/20", Icon: WhatsAppIcon, message: "New order received!", time: "11:24" },
    { platform: "Instagram", color: "bg-pink-500/20", Icon: InstagramIcon, message: "New message from user", time: "11:24" },
    { platform: "Telegram", color: "bg-[#0088cc]/20", Icon: TelegramIcon, message: "New customer inquiry", time: "11:25" },
    { platform: "Messenger", color: "bg-[#0084FF]/20", Icon: MessengerIcon, message: "User requested support", time: "11:25" }
  ];
