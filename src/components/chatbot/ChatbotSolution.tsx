      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <h2 className="text-4xl md:text-5xl font-serif font-light text-white mb-8">
            AI Chatbot That <span className="text-[#c9a961] font-normal">Converts Like Your Best Rep</span>
          </h2>
          
          <p className="text-xl text-white/70 font-light leading-relaxed">
            O.N.E.Tech builds AI chatbots that handle customer conversations across all channels—WhatsApp, Instagram, website, Telegram—automatically turning conversations into sales.
          </p>
        </div>
      </div>
    </section>
