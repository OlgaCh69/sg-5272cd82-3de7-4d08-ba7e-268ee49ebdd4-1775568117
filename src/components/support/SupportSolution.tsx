      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <h2 className="text-4xl md:text-5xl font-serif font-light text-white mb-8">
            AI That Handles Support <span className="text-[#c9a961] font-normal">Better Than Humans</span>
          </h2>
          
          <p className="text-xl text-white/70 font-light leading-relaxed">
            O.N.E.Tech builds AI support automation that resolves 70-85% of tickets autonomously, responds in under 60 seconds, and turns support conversations into upsell opportunities—automatically, at scale, 24/7.
          </p>
        </div>
      </div>
    </section>
