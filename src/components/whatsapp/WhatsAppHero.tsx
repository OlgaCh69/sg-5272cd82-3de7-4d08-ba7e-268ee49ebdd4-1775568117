...
import { ArrowRight, Play, MessageCircle, TrendingUp, Clock } from "lucide-react";
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 mb-8 bg-white/5 backdrop-blur-sm border border-white/10 rounded-full">
            ...
            <span className="text-sm text-white/80 font-light tracking-wide">WhatsApp Automation for Elite Ecommerce</span>
          </div>

          {/* Main Heading */}
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-serif mb-8 leading-[1.1]">
            <span className="text-white font-light">Turn WhatsApp Into Your</span>
            <br />
            <span className="text-white font-light">Most Profitable</span>
            <br />
            <span className="text-[#c9a961] font-normal">Revenue Channel</span>
          </h1>

          {/* Subheading */}
          <p className="text-xl sm:text-2xl text-white/70 mb-12 max-w-2xl font-light leading-relaxed">
            Recover abandoned carts, automate customer conversations, and close more sales with 24/7 AI automation built for high-growth ecommerce brands.
          </p>
          ...
          <div className="grid grid-cols-3 gap-8 max-w-2xl">
            <div className="text-center sm:text-left">
              <div className="flex items-center justify-center sm:justify-start gap-2 mb-2">
                ...
                <p className="text-3xl font-light text-white">15-30%</p>
              </div>
              <p className="text-sm text-white/60 font-light">Cart recovery</p>
            </div>
            <div className="text-center sm:text-left">
              <div className="flex items-center justify-center sm:justify-start gap-2 mb-2">
            ...
            <div className="text-center sm:text-left">
              ...
              <p className="text-sm text-white/60 font-light">Always active</p>
            </div>
          </div>
        </div>
      </div>
