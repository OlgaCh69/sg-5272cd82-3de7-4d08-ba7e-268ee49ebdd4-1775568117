        ...
        <div className="max-w-4xl mx-auto text-center mb-12">
          ...
          <div className="max-w-2xl mx-auto space-y-4 mb-8">
            {[
              ...
              <div key={index} className="flex items-center gap-3 bg-white/5 backdrop-blur-sm p-4 rounded-xl border border-white/10">
          ...
          <p className="text-base md:text-lg text-gray-300 p-6 bg-gradient-to-br from-[#d4af37]/10 to-[#ffb6c1]/10 rounded-xl border border-[#d4af37]/20">
            Our AI receptionist doesn't just respond—it <span className="font-bold text-[#d4af37]">actively recovers lost opportunities</span> and turns them into confirmed appointments.
          </p>
        </div>
      </div>
    </section>
