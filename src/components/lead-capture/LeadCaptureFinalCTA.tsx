...
export function LeadCaptureFinalCTA() {
  return (
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 text-white leading-tight">
            Ready to Turn More Conversations Into Customers?
          </h2>
          <p className="text-xl text-gray-300 mb-8">
            Your website visitors, WhatsApp inquiries, and Instagram DMs should not sit unanswered. Build an AI lead capture assistant that works 24/7 and sends qualified leads straight to your sales pipeline.
          </p>
